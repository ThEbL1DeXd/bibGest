...
namespace bibGest.Controllers
{
    public class UtilisateursController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UtilisateurId,Nom,Prenom,Email,MotDePasseHash,Role,Telephone,DateInscription,EstActif")] Utilisateur utilisateur)
        {
